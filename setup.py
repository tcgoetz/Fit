...
setup(name=module_name, version=module_version, author='Tom Goetz', packages=[module_name, f'{module_name}.conversions', f'{module_name}.checks', f'{module_name}.exceptions', f'{module_name}.fields', f'{module_name}.fields.field_enums', f'{module_name}.fields.enum_fields', f'{module_name}.messages'],
