...
from ..measurement import Distance, Speed, Weight, Longitude, Latitude, Temperature,  MeasurementSystem
...
class ObjectField(Field):
    ...
    def reconvert(self, value_obj, invalid, measurement_system=MeasurementSystem.metric):
        """Return a FieldValue containing the field value as a Python object."""
        self.measurement_system = measurement_system
...
class DistanceKmsField(DistanceMetersField):
    """Field holding a distance measure in meters."""

    def __init__(self, name):
        """Return a DistanceCentimetersToKmsField instance."""
        super().__init__(name, Distance.from_kilometers, Distance.kms_or_miles)
