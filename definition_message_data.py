...
class DefinitionMessageData():
    ...
    known_messages = {
        ...
        MessageType.session : {
            ...
            22 : object_fields.DistanceMetersField(name='total_ascent'),
            23 : object_fields.DistanceMetersField(name='total_descent'),
        ...
        MessageType.device_info : {
            ...
            24 : fields.NamedField('sensor_id'),
