...
class DefinitionMessage(Data):
    ...
    known_messages = {
        ...
        18  : [ 'session', {
                    ...
                    35 : Field('training_stress_score'),
                    36 : Field('intensity_factor'),
                    37 : Field('left_right_balance'),
                    41 : Field('avg_stroke_count'),
                    42 : Field('avg_stroke_distance'),
                    43 : Field('swim_stroke'),
                    44 : Field('pool_length'),
                    45 : Field('threshold_power'),
                    46 : Field('pool_length_unit'),
                    47 : Field('num_active_lengths'),
                    48 : Field('total_work'),
                    49 : Field('avg_altitude'),
                    50 : Field('max_altitude'),
                    51 : Field('gps_accuracy'),
                    52 : Field('avg_grade'),
                    53 : Field('avg_pos_grade'),
                    54 : Field('avg_neg_grade'),
                    55 : Field('max_pos_grade'),
                    56 : Field('max_neg_grade'),
                    57 : TemperatureField('avg_temperature'),
                    58 : TemperatureField('max_temperature'),
                    59 : Field('avg_pos_vertical_speed'),
                    60 : Field('max_altitude'),
                    ...
                    94 : Field('total_fractional_cycles'),
                    101 : Field('avg_left_torque_effectiveness'),
